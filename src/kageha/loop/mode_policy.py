...
MODE_PROMPTS: dict[str, str] = {
    ...
    "multitask": (
        ...
        "Delegate only substantial independent workstreams that each benefit from separate model "
        "judgment. Do not spawn agents for a few small tool calls, sequential UI actions, or work "
        "that one agent can finish in roughly two steps. When delegation is warranted, make "
        "spawn_subagents or spawn_task_graph the first tool call. If the request is small or "
        "sequential, execute it directly. "
